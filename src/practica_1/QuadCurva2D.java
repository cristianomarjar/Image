 ...
 */
public class QuadCurva2D extends javax.swing.JFrame {

    /**
     * Creates new form QuadCurva2D
     */
    public QuadCurva2D() {
        initComponents();
    }
...
g2.draw(new Rectangle2D.Float(190.0f, 220.0f, 1.0f, 1.0f));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuadCurva2D.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuadCurva2D().setVisible(true);
            }
        });
    }
